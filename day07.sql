...
INSERT INTO musteriler1 (id, isim, maas) VALUES (1001, 'Ali', 100000);  
INSERT INTO musteriler1 (id, isim, maas) VALUES (1002, 'Ayse', 57500);  
INSERT INTO musteriler1 (id, isim, maas) VALUES (1003, 'Feride', 71000);
INSERT INTO musteriler1 (id, isim, maas) VALUES (1004, 'Fatma', 42000);  
INSERT INTO musteriler1 (id, isim, maas) VALUES (1005, 'Kasim', 44000);
INSERT INTO musteriler1 (id, isim, maas) VALUES (1006, 'ahmet', 82000);
...
--ilike buyuk harf kucuk harf gözetmeksizin  istenildiğinde kullanılır

--SORU4: isim'i 'e' harfi ile biten tum bilgileri listeleyiniz


select * from musteriler1 where isim like '%e';

--SORU5: isim'i icerisinde 'er' olan tum bilgileri listeleyiniz.
select * from musteriler1 where isim like '%er%';
...
select * from musteriler1 where isim not like '%i%';
...
--NOT: ~* buyuk harf kucuk harf gözetmeksizin istenldiğinde kullanılır
...
--NOT: "$" SEMBOLÜ BİTEN ANLAMINDA KULLANILIR
--     "~" SEMBOLÜ BAŞLAYAN ANLAMINDA KULLANILIR (edited) 
