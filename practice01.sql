--STUDENTS İSİMLİ BİR TABLE OLUSTURUNUZ
...
(
  ...
  --İNSERT:VERİ TABANINA YENİ VERİ EKLER
...
--SORU2: ogrenciler tablosundaki sinav_notu 85'den büyük olan öğrencilerin tüm bilgilerini listele
select * from students where sinav_notu>85;


--SORU3: ogrenciler tablosundaki adres'i 'Ankara' olan öğrenci isim'ini listele

select isim from students where adres='Ankara';


--SORU4: ogrenciler tablosundaki sinav_notu 85 üzeri ve adres'i 'Ankara' olan öğrenci isim'ini listele
